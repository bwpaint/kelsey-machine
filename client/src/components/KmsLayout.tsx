...
export const KMS_ADDRESS =
  "814 Summer Park Dr, Building #600, Stafford, TX 77477";
...
export function NavBar() {
  ...
  return (
    ...
    >
      ...
      {/* Main nav row — BLACK */}
      <div
        style={{ background: C.black, borderBottom: `2px solid ${C.green}33` }}
      >
        <div
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div
              ...
              style={{ paddingBottom: "0.75rem", marginBottom: "-0.75rem" }}
            >
              <button
                style={{
                  fontFamily: "'Barlow', sans-serif",
                ...
                {SERVICE_NAV.map(({ label, href }) => (
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: "0.78rem",
                      color:
                        location === href ? C.green : "rgba(255,255,255,0.8)",
                      textDecoration: "none",
                      letterSpacing: "0.04em",
            ...
            {[
              ...
              <Link
                ...
                style={{
                  ...
                  fontWeight: 700,
                  fontSize: "0.82rem",
                  color: location === href ? C.green : "rgba(255,255,255,0.88)",
                  letterSpacing: "0.07em",
                  textTransform: "uppercase",
                  textDecoration: "none",
                  transition: "color 0.2s",
                ...
                onMouseLeave={e =>
                  (e.currentTarget.style.color =
                    location === href ? C.green : "rgba(255,255,255,0.88)")
                }
              >
                {label}
              </Link>
      ...
      {open && (
        <div
          style={{
            ...
            borderTop: `1px solid rgba(120,165,70,0.3)`,
          }}
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          {[
            ...
            {
              icon: <Star size={14} />,
              text: "All 50 States + Canada + Mexico",
            },
          ].map(({ icon, text }) => (
            <div
              key={text}
...
export function QuickAnswerBox({ text }: QuickAnswerProps) {
  return (
    <div
      style={{
        background: `linear-gradient(135deg, ${C.blueDark}15 0%, ${C.green}12 100%)`,
...
export function InlineQuoteForm({
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Something went wrong. Please call us at 346-350-1464."
      );
    } finally {
      setSubmitting(false);
    }
    ...
    return (
      ...
      >
        ...
        <p
          style={{
            fontFamily: "'Source Sans 3', sans-serif",
            color: dark ? "rgba(255,255,255,0.7)" : C.textMid,
            fontSize: "0.95rem",
          }}
        >
          A KMS specialist will be in touch within the hour. For emergencies,
          call{" "}
          <a href={KMS_PHONE_HREF} style={{ color: C.green, fontWeight: 700 }}>
            {KMS_PHONE}
          </a>{" "}
          right now.
        </p>
  ...
  return (
    <div
      style={{ background: bg, border, borderRadius: 4, padding: "1.75rem" }}
    >
      <div
        style={{
          fontFamily: "'Barlow Condensed', sans-serif",
      ...
      <p
        style={{
          fontFamily: "'Source Sans 3', sans-serif",
          fontSize: "0.88rem",
          color: dark ? "rgba(255,255,255,0.6)" : C.textMid,
...
// ─── Sidebar callouts (reused across blog + service + about pages) ───────────
...
export function WarrantyCallout() {
  return (
    ...
    >
      ...
      >
        Every repair we perform is backed by our industry-leading{" "}
        <strong style={{ color: C.green }}>24-month written warranty</strong> —
        twice the industry standard. If something goes wrong after we fix it, we
...
export function FreeNationwidePickupCallout() {
  return (
    <div
      style={{
        background: C.green,
    ...
    >
      ...
      >
        We'll pick up your equipment anywhere in the continental U.S. — at no
        charge. Just call or submit the form above.
      </p>
    </div>
  );
}
...
export function EmergencyCallout() {
  return (
    ...
    >
      ...
      >
        When your equipment goes down, every hour costs you. Call us anytime,
        day or night — we respond within the hour.
      </p>
      <a
        href={KMS_PHONE_HREF}
        style={{
      ...
      <div className="flex flex-col gap-2">
        {faqs.map((faq, i) => (
          <div
            ...
            style={{
              background: "white",
              border: `1px solid ${open === i ? C.green : "#dde3ec"}`,
              borderRadius: 4,
              overflow: "hidden",
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-6">
          ...
          >
            The right people, the right equipment, the right technology —
            keeping your operations running since 1984.
          </p>
...
export function Footer() {
  ...
  return (
    <footer
      style={{ background: C.darkBg, borderTop: `3px solid ${C.green}` }}
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            >
              Texas' most trusted rotating equipment repair shop. Serving all 50
              states, Canada, and Mexico since 1983.
            </p>
            {[
              {
                icon: <Phone size={14} />,
            ...
            <div className="flex items-start gap-2 mt-1">
              <span style={{ color: C.green, marginTop: 2 }}>
                <MapPin size={14} />
              </span>
              <div
                style={{
              ...
              >
                ...
                <a
                  href="https://maps.google.com/?q=814+Summer+Park+Dr+Building+600+Stafford+TX+77477"
                  target="_blank"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-between items-center gap-3">
          ...
          >
            © {new Date().getFullYear()} Kelsey Machine Services. All rights
            reserved. | Stafford, TX 77477
          </p>
...
export function CtaBanner({
  headline = "Ready to Get Your Equipment Back Online?",
  subtext = "Call us now or request a free quote — we respond within the hour, 24/7 for emergencies.",
  dark = true,
}: CtaBannerProps) {
  return (
    <section
      style={{
        background: dark ? C.darkBg : C.blueDark,
        padding: "3.5rem 0",
        borderTop: `3px solid ${C.green}33`,
      }}
    >
