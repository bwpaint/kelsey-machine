            ...
            <div className="lg:col-span-2">
              {submitted ? (
                ...
                >
                  ...
                  >
                    Someone from our team will be in touch within one business
                    hour. For urgent situations, call our{" "}
                    <Link
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    >
                      Describe Your Equipment & Situation
                    </label>
                    <textarea
                      id="message"
                      rows={5}
            ...
            <div className="lg:col-span-1">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    },
                    {
                      icon: <Mail size={18} />,
                      label: "Email",
                      value: "info@kmstx.com",
                      href: "mailto:info@kmstx.com",
                    },
                    {
                      icon: <MapPin size={18} />,
                      label: "Location",
                      value: "Stafford, TX 77477",
                      href: undefined,
                    },
              ...
              >
                ...
                >
                  ...
                  is available every day of the year. Call the emergency line
