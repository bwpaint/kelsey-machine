...
const FAILURE_MODES = [
  {
    ...
    title: "Scroll Wear & Erosion",
    desc: "When scroll-to-bowl clearance opens up, separation efficiency drops and throughput falls. Left unchecked, the scroll eventually contacts the bowl wall — a very costly failure that we see more often than we should.",
  },
  {
    icon: <AlertTriangle size={18} />,
    title: "Bowl Damage",
    desc: "Corrosion, erosion, cracking, and out-of-round conditions all affect bowl performance and safety. Often the result of running abrasive slurries without adequate wear protection or operating above design spec.",
  },
  {
    icon: <AlertTriangle size={18} />,
    title: "Bearing Failure",
    desc: "Centrifuge bearings carry high radial and axial loads at significant speeds. Contamination, overloading, improper lubrication, and misalignment are the leading causes. Vibration and noise are usually the first signs.",
  },
  {
    icon: <AlertTriangle size={18} />,
    title: "Internal Gearbox Problems",
    desc: "Decanter centrifuges use a differential gearbox to maintain scroll-to-bowl speed. Gearbox wear, oil contamination, and seal failure are common — and require complete gearbox rebuild capability. We have that in-house. See our Gearbox Repair page for more.",
  },
  {
    icon: <AlertTriangle size={18} />,
    title: "Vibration & Imbalance",
    desc: "Excessive vibration is a symptom, not a root cause. Worn bearings, damaged scroll flights, bowl damage, or process material buildup on rotating components — we diagnose the root cause rather than just chase the symptom.",
  },
  {
    icon: <AlertTriangle size={18} />,
    title: "Seal & Gasket Failure",
    desc: "Leaking process fluid, contaminated oil, or loss of internal pressure are all signs of seal failure. We replace all seals and gaskets as part of a standard rebuild — not as an add-on.",
  },
];
...
const REPAIR_PROCESS = [
  {
    ...
    desc: "Every centrifuge that comes through our doors gets a complete disassembly and written failure analysis before a single repair is authorized. You'll know exactly what failed, why it failed, and what it will cost to fix it — before we touch a wrench.",
  },
  {
    step: "02",
    title: "Component Assessment",
    desc: "We measure, test, and evaluate every component against OEM specifications. Scroll flights, bowl dimensions, bearing fits, gearbox condition, seal surfaces — all documented. No guessing, no assuming.",
  },
  {
    step: "03",
    title: "Precision Machining & Repair",
    desc: "Our in-house machine shop handles bowl restoration, scroll flight rebuilding, shaft repair, and bearing housing reconditioning. We don't farm out the critical work — it stays in our shop under our supervision.",
  },
  {
    step: "04",
    title: "Dynamic Balancing",
    desc: "Every rotating assembly is dynamically balanced before reassembly. This isn't optional — it's standard. An unbalanced centrifuge will destroy its own bearings and vibrate itself apart. We balance it right the first time.",
  },
  {
    step: "05",
    title: "Reassembly & Testing",
    desc: "Rebuilt to OEM specifications, tested under load, and documented. You receive a complete repair report with before/after measurements, component replacement records, and test results.",
  },
  {
    step: "06",
    title: "Warranty & Return",
    desc: "Every centrifuge repair is backed by our industry-leading 24-month rebuilt warranty. We coordinate return freight and get your equipment back to you fast — because downtime costs real money.",
  },
];
...
export default function CentrifugeRepair() {
  const schema = {
    ...
    description:
      "KMS repairs all centrifuge types and brands — decanter, disc stack, basket, scroll & solid-bowl. OEM-level rebuilds, emergency service, nationwide. Free quote.",
    offers: {
      "@type": "Offer",
      description:
        "Free inspection and itemized quote before any work is authorized.",
    },
  };
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://kmstx.com",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Services",
        item: "https://kmstx.com/services",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Centrifuge Repair",
        item: "https://kmstx.com/services/centrifuge-repair",
      },
    ],
  };
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              >
                If your centrifuge just quit on you, you've got two options:
                call the OEM and wait six weeks, or call Kelsey Machine and get
                it done right. We've been the go-to centrifuge repair shop in
                Texas — and across all 50 states — for over 40 years. We repair
                every centrifuge type, every brand, and we back every rebuild
                with a written{" "}
                <Link
                  href="/warranty"
                  style={{
              ...
              >
                Kelsey Machine Services provides expert industrial centrifuge
                repair and rebuild services for oilfield operations, wastewater
                treatment plants, food and beverage processors, pharmaceutical
                facilities, and mining operations. We work on all centrifuge
                types and all manufacturers, with a structured repair process
                that gives you full transparency from intake to delivery. No
                surprises, no shortcuts, and no guessing on root cause — every
                unit gets a written failure analysis before we touch a wrench.
              </p>
              ...
              >
                KMS has hands-on experience across every major centrifuge
                configuration in industrial use. Whether you're running a
                decanter in a wastewater plant or a disc stack in a
                pharmaceutical clean room, we've seen it, fixed it, and sent it
                back running better than before.
              </p>
              ...
              >
                Understanding failure modes helps you catch problems before they
                become catastrophic — and before a $5,000 repair turns into a
                $50,000 replacement. Here's what we see most often:
              </p>
              ...
              >
                ...
                >
                  Every hour your centrifuge sits idle costs you money. Our{" "}
                  <Link
                  ...
                  means we pick up the phone at 2 AM on a Sunday — and we can
                  have your unit in our shop faster than you think.
                </p>
              ...
              >
                We've been doing this long enough to know that the shops that
                cut corners on process are the ones you call us to fix after the
                fact. Here's exactly what happens when your centrifuge arrives
                at KMS:
              </p>
              ...
              >
                Centrifuges are everywhere in industrial processing — and so are
                we. KMS serves facilities and contractors across every major
                industrial sector:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                {[
                  {
                    sector: "Petrochemical & Oil and Gas",
                    detail:
                      "Refineries, pipelines, upstream/downstream processing, drilling contractors",
                  },
                  {
                    sector: "Wastewater Treatment",
                    detail:
                      "Municipal and industrial water/wastewater treatment plants, biosolids dewatering",
                  },
                  {
                    sector: "Food & Beverage",
                    detail:
                      "Processing equipment, sanitary environments, dairy, edible oils, beverages",
                  },
                  {
                    sector: "Pharmaceutical & Biotech",
                    detail:
                      "Clean-room aware repair, disc stack and basket centrifuges, tight tolerances",
                  },
                  {
                    sector: "Mining & Aggregate",
                    detail:
                      "Solids recovery, dewatering, mill operations, heavy slurry applications",
                  },
                  {
                    sector: "Manufacturing & MRO",
                    detail:
                      "Industrial contractors managing repairs on behalf of facilities nationwide",
                  },
                ].map(({ sector, detail }) => (
                  <div
                    key={sector}
              ...
              >
                We're not limited to OEM service relationships. If it's a
                centrifuge, we can fix it — regardless of who made it. Here are
                some of the brands we work on regularly:
              </p>
              ...
              >
                There are a lot of shops that say they repair centrifuges.
                Here's what makes KMS different — and why our customers keep
                coming back:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                {[
                  {
                    ...
                    desc: "We don't farm out the critical work. Our machine shop handles bowl restoration, scroll flight rebuilding, and shaft repair under our roof, under our supervision.",
                  },
                  {
                    icon: <Shield size={18} />,
                    title: "24-Month Written Warranty",
                    desc: "The strongest warranty in the business. Every centrifuge repair is backed in writing — not just a verbal promise. See our Warranty page for full terms.",
                  },
                  {
                    icon: <Clock size={18} />,
                    title: "24/7 Emergency Response",
                    desc: "Equipment doesn't break on a schedule. Our emergency line is answered every day of the year. We respond immediately and can arrange free pickup for critical situations.",
                  },
                  {
                    icon: <CheckCircle size={18} />,
                    title: "All Brands, No Exceptions",
                    desc: "We repair any manufacturer's equipment — not just OEMs we're contracted with. If it's in your facility, we can fix it.",
                  },
                  {
                    icon: <ArrowRight size={18} />,
                    title: "Transparent Quoting",
                    desc: "You receive a detailed, itemized quote after inspection — before any work is authorized. No surprises at invoice. No hidden fees.",
                  },
                  {
                    icon: <ArrowRight size={18} />,
                    title: "Nationwide Reach",
                    desc: "We receive equipment from all 50 states, Canada, and Mexico and coordinate inbound freight as part of our service. Geography is never the reason you can't get your centrifuge repaired right.",
                  },
                ].map(({ icon, title, desc }) => (
                  <div
                    key={title}
              ...
              >
                Centrifuge repair often goes hand-in-hand with other rotating
                equipment work. KMS handles all of it under one roof:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {[
                  {
                    title: "Gearbox Repair",
                    desc: "Decanter centrifuges use internal differential gearboxes. We rebuild those in-house.",
                    href: "/services/gearbox-repair",
                  },
                  {
                    title: "Industrial Blower Repair",
                    desc: "Many centrifuge operations run blowers for aeration and conveying. We repair those too.",
                    href: "/services/industrial-blower-repair",
                  },
                  {
                    title: "Fluid & Power End Repair",
                    desc: "For oilfield operations running centrifuges alongside mud pumps.",
              ...
              <div style={{ position: "sticky", top: 100 }}>
                ...
                >
                  ...
                  >
                    ...
                    is answered every day of the year. We respond immediately.
                  </p>
                  <a
                    href={KMS_PHONE_HREF}
                    style={{
                  ...
                  >
                    ...
                    >
                      Every repair backed by a{" "}
                      <Link
                        href="/warranty"
                        style={{ color: C.green, textDecoration: "none" }}
                      >
                        written 24-month warranty
                      </Link>{" "}
      ...
      <FaqSection
        faqs={FAQS}
        pageName="Industrial Centrifuge Repair"
        showForm
        service="centrifuge"
      />
      <NewsletterBar />
