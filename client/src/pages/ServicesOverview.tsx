...
const SERVICES = [
  { title: "Centrifuge Repair", desc: "Comprehensive repair, rebuild, and reconditioning for all types of industrial centrifuges — decanter, basket, disc stack, and more. We service all major brands including Alfa Laval, Andritz, Bird, Sharples, and Flottweg.", href: "/services/centrifuge-repair", kw: "centrifuge repair" },
  { title: "Gearbox Repair", desc: "Full-service gearbox repair and overhaul for speed reducers, speed increasers, planetary gearboxes, and cooling tower drives. We handle all phases from inspection to final balancing. Brands: Falk, Lufkin, Amarillo, Rexnord, Sumitomo, Flender, SEW, David Brown, Voith, and more.", href: "/services/gearbox-repair", kw: "gearbox repair" },
  { title: "Pump Repair & Rebuild", desc: "Expert repair for all pump types — centrifugal, vertical turbine, horizontal split case, and positive displacement. Impeller rebuilds, hard-facing, and seal replacement included. All major brands serviced.", href: "/pump-service", kw: "pump repair" },
  { title: "Blower Repair", desc: "Industrial blower repair, rebuild, and reconditioning — including Roots-style PD blowers, multi-stage centrifugals, and regenerative blowers. We service Roots, Tuthill, Aerzen, Hoffman, Spencer, and every other major manufacturer in the field.", href: "/services/industrial-blower-repair", kw: "blower repair" },
  { title: "Compressor Repair", desc: "Full-service industrial compressor repair and overhaul — centrifugal, reciprocating, rotary screw, and oil-flooded designs. Bearing replacement, impeller rebuild, dynamic balancing, and complete teardown-and-rebuild to OEM spec. Kaeser, Atlas Copco, Ingersoll Rand, Sullair, and more.", href: "/services/industrial-compressors", kw: "compressor repair" },
  { title: "Fluid End & Power End Repair", desc: "Specialized repair and refurbishment for oilfield mud pump fluid ends and power ends. We restore fluid end modules — one-piece, two-piece, L-shaped, and valve-over-valve — using proprietary welding and machining. Brands: Lewco, Kerr, NOV, Gardner Denver, Weatherford, Emsco, and more.", href: "/services/fluid-power-end-repair", kw: "fluid end repair" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-10 items-start">
            <div className="lg:col-span-2">
              ...
              <p style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: "1.08rem", color: C.textDark, lineHeight: 1.8, marginTop: "1.25rem" }}>
                What separates KMS from other <strong>rotating equipment repair companies</strong> is our fully integrated in-house capability. We don’t subcontract the precision work — our own machine shop handles every bore, weld, and balance job under one roof in Stafford, Texas. That means tighter tolerances, faster turnaround, and a single point of accountability from teardown to test. Whether you need a <strong>centrifuge bowl and scroll rebuild</strong>, a <strong>parallel-shaft or planetary gearbox overhaul</strong>, a <strong>roots blower restoration</strong>, or a complete <strong>mud pump fluid end and power end rebuild</strong>, every job follows the same documented repair process and ships back to you with a full inspection report. We serve customers across all 50 states, Canada, and Mexico, and our <strong>free nationwide pickup and delivery</strong> means geography is never a barrier to getting the best repair available.
              </p>
              <p style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: "1.08rem", color: C.textDark, lineHeight: 1.8, marginTop: "1.25rem" }}>
                Industrial facilities, petrochemical plants, oilfield operators, and municipal water treatment facilities all depend on KMS because we understand that unplanned downtime is not an option. Our standard turnaround is <strong>72 hours</strong> from receipt of equipment, and our <strong>24/7 emergency repair service</strong> — answered every day of the year including weekends and holidays — means a certified KMS specialist is always available when a critical piece of rotating equipment fails unexpectedly. If you are searching for the <strong>best companies for fluid end and power end repair services in the U.S.</strong>, a <strong>certified rotating equipment repair specialist near you</strong>, or simply a shop that will stand behind its work with a written warranty, Kelsey Machine Services has the experience, the equipment, and the track record to back it up. Call us today or submit a quote request — we respond within the hour.
              </p>
            </div>
