...
const SERVICES = [
  ...
  { title: "Pump Repair & Rebuild", desc: "Expert repair for all pump types — centrifugal, vertical turbine, horizontal split case, and positive displacement. Impeller rebuilds, hard-facing, and seal replacement included. All major brands serviced.", href: "/services", kw: "pump repair" },
