...
const REASONS = [
  {
    ...
    body: "Twice what the industry calls 'standard.' We put it in writing, not in a sales pitch. If something fails inside 24 months, we make it right at no charge.",
  },
  {
    icon: <Truck size={28} style={{ color: C.green }} />,
    title: "Free Nationwide Pickup",
    body: "We come to you, anywhere in the continental U.S. — at no charge. Your team doesn't book freight, deal with damage claims, or coordinate three different trucking companies.",
  },
  {
    icon: <Clock size={28} style={{ color: C.green }} />,
    title: "24/7 Emergency Response",
    body: "Our emergency line is answered every day of the year. When your facility is offline, the clock doesn't care that it's 3am on a Sunday. Neither do we.",
  },
  {
    icon: <Award size={28} style={{ color: C.green }} />,
    title: "40+ Years of Experience",
    body: "We've been doing this since 1983. That kind of longevity in this industry doesn't happen by accident — it happens by treating customers right and standing behind the work, every job, every time.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div className="lg:col-span-2">
              ...
              >
                When you're choosing a rotating equipment repair shop, the
                marketing claims all start to sound the same. Everybody says
                they're "the best." Everybody says they have "years of
                experience." Everybody says they "stand behind their work." So
              ...
              >
                You compare them on the things that affect your operation.
                Warranty length. Turnaround time. Documentation. Whether they
                have an actual machine shop in-house or whether they're
                outsourcing the precision work. Whether they answer the phone at
                3am when your blower seizes. Below is how Kelsey Machine
                Services compares to the typical industrial repair shop on the
              ...
              >
                ...
                >
                  Already getting quotes from other shops? Send us the spec and
                  let us put our pricing, turnaround, and warranty side-by-side
                  with theirs. No obligation. No high-pressure sales.
                </p>
                <a
                  href={KMS_PHONE_HREF}
                  style={{
