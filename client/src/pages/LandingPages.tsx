    ...
    return (
      ...
      >
        ...
        >
          ...
          <a href={KMS_PHONE_HREF} style={{ color: C.green }}>
            {KMS_PHONE}
          </a>
        </p>
      </div>
...
function LandingPageTemplate({
  ...
  return (
    <>
      ...
      <section
        style={{
          background: `linear-gradient(135deg, ${C.darkBg} 0%, ${C.blueDark} 100%)`,
          padding: "4rem 0 3rem",
          minHeight: "85vh",
          display: "flex",
          alignItems: "center",
        ...
        <div className="max-w-7xl mx-auto px-4 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                We respond within one business hour. Emergency? Call us
                directly.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              {[
                {
                  label: "24-Month Written Warranty",
                  desc: "The industry standard is 90 days. We give you 24 months — in writing.",
                },
                {
                  label: "Free National Pickup",
                  desc: "We'll come get your equipment anywhere in the continental U.S.",
                },
                {
                  label: "24/7 Emergency Service",
                  desc: "Our emergency line is answered every day of the year. No exceptions.",
                },
                {
                  label: "All 50 States + Canada & Mexico",
                  desc: "Distance is not a barrier. We serve North America.",
                },
              ].map(({ label, desc }) => (
                <div
                  key={label}
      ...
      >
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          >
            Backed by a 24-month written warranty · Free pickup in all 50 states
            · 24/7 emergency service · Canada & Mexico service available
          </div>
        </div>
      </section>
