...
import { NavBar, Footer, NewsletterBar, PageHero, C } from "@/components/KmsLayout";
import { BlogSidebar } from "@/components/BlogSidebar";
import { fetchPosts, formatPostDate, getFeaturedImage, stripHtml, type WpPost } from "@/lib/wpApi";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {posts.map((post) => {
                    ...
                    return (
                      ...
                      >
                        {img.src && (
                          <div style={{ width: "100%", height: 180, background: `url(${img.src}) center/cover no-repeat`, borderBottom: "1px solid #dde3ec" }} />
                        )}
                        <div style={{ padding: "1.25rem 1.25rem 1.5rem" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 6, fontFamily: "'Barlow', sans-serif", fontSize: "0.78rem", color: C.textMid, marginBottom: "0.5rem" }}>
                            <Calendar size={12} />
                            {formatPostDate(post.date)}
                          </div>
                          <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "1.25rem", color: C.blueDark, textTransform: "uppercase", letterSpacing: "-0.01em", lineHeight: 1.15, marginBottom: "0.65rem" }}>
                            {titleText}
                          </h2>
                          <p style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: "0.92rem", color: C.textMid, lineHeight: 1.55, marginBottom: "0.9rem" }}>
                            {excerpt}{excerpt.length >= 180 ? "…" : ""}
                          </p>
                          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: "0.88rem", color: C.green, textTransform: "uppercase", letterSpacing: "0.06em" }}>
              ...
              {!loading && totalPages > 1 && (
                <div className="flex items-center justify-center gap-2" style={{ marginTop: "2.5rem" }}>
                  <button
                    type="button"
                  ...
                  <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.88rem", color: C.textMid, padding: "0 1rem" }}>
