...
const FAQS = [
  { q: "What does the KMS 24-month warranty cover?", a: "The KMS 24-month warranty covers all parts replaced and all work performed during the repair — including bearings, seals, gaskets, machined surfaces, gear sets, impellers, rotors, valves, and labor. The warranty is in writing and included in your documentation package." },
  { q: "How do I make a warranty claim?", a: "Call our main line at 346-350-1464 or email us to initiate a warranty claim. We'll arrange pickup of the equipment, inspect it, and determine the appropriate remedy — repair, rebuild, or replacement — at no charge to you." },
  { q: "Does the warranty cover equipment that fails due to a different cause than the original repair?", a: "The warranty covers the specific work performed. If a different component fails due to an unrelated cause, that would be a new repair rather than a warranty claim. We'll always give you an honest assessment." },
  { q: "Is the warranty transferable?", a: "The warranty follows the equipment for the 24-month period from the date of repair, regardless of ownership. Contact us to transfer warranty documentation." },
  { q: "What is the industry standard warranty for rotating equipment repair?", a: "Most repair shops offer 90-day to 12-month warranties. KMS's 24-month warranty is significantly longer than the industry standard — and it's in writing, not just a verbal promise." },
];
...
export default function Warranty() {
  return (
    <>
      <NavBar />
      <PageHero
        bgImage="/manus-storage/gearbox-open_e1ff237b_ade7e272.jpg"
      ...
      <main style={{ background: "white" }}>
        <div className="max-w-5xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div style={{ background: C.lightBg, border: `2px solid ${C.green}`, borderRadius: 4, padding: "2rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1.25rem" }}>
                <Shield size={24} style={{ color: C.green }} />
                <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "1.3rem", color: C.blueDark, textTransform: "uppercase", margin: 0 }}>What's Covered</h2>
              </div>
            ...
            <div style={{ background: C.lightBg, border: `2px solid #dde3ec`, borderRadius: 4, padding: "2rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1.25rem" }}>
                <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "1.3rem", color: C.blueDark, textTransform: "uppercase", margin: 0 }}>What's Not Covered</h2>
              </div>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                {NOT_COVERED.map(item => (
                  <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                    <span style={{ color: "#aaa", flexShrink: 0, marginTop: 2, fontSize: "1rem" }}>✕</span>
                    <span style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: "0.95rem", color: C.textMid, lineHeight: 1.5 }}>{item}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div style={{ background: `linear-gradient(135deg, ${C.blueDark} 0%, ${C.darkBg} 100%)`, borderRadius: 4, padding: "2.5rem", marginBottom: "2.5rem" }}>
            <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "1.75rem", color: "white", textTransform: "uppercase", letterSpacing: "-0.01em", marginBottom: "0.75rem" }}>
              24 Months. In Writing. Every Time.
            </div>
            <p style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: "1rem", color: "rgba(255,255,255,0.75)", lineHeight: 1.7, marginBottom: "1.5rem", maxWidth: 600 }}>
              Ready to get your equipment repaired by a shop that stands behind its work? Request a free quote or call our <Link href="/emergency-service" style={{ color: C.green, fontWeight: 700, textDecoration: "none" }}>24/7 emergency line</Link> — we're ready when you are.
            </p>
