...
const topPages = [
  {
    title: "Kelsey Machine Services: Home",
    url: "kmstx.com/",
    visits: 0,
    backlinks: 0,
  },
  {
    title: "Centrifuge Repair Service",
    url: "kmstx.com/centrifuge-repair-service/",
    visits: 0,
    backlinks: 0,
  },
];
...
const currentKeywords = [
  {
    keyword: "compressor and turbine services",
    volume: 260,
    position: 47,
    difficulty: 26,
    url: "kmstx.com/",
...
const competitors = [
  {
    domain: "houstondynamic.com",
    commonKeywords: 2,
    keywordGap: 607,
    estimatedTraffic: 1033,
    backlinks: 976,
    score: 85,
  },
  {
    domain: "centrifuge.com",
    commonKeywords: 1,
    keywordGap: 197,
  ...
  {
    domain: "sentrimax.com",
    commonKeywords: 1,
    keywordGap: 23,
    estimatedTraffic: 218,
    backlinks: 828,
    score: 45,
  },
  {
...
const keywordGapOpportunities = [
  {
    keyword: "centrifuge repair service",
    volume: 480,
    difficulty: 18,
    intent: "Commercial",
    priority: "High",
  ...
  {
    keyword: "industrial centrifuge repair",
    volume: 390,
    difficulty: 22,
    intent: "Commercial",
    priority: "High",
  ...
  {
    keyword: "gearbox repair service",
    volume: 720,
    difficulty: 31,
    intent: "Commercial",
    priority: "High",
  ...
  {
    keyword: "rotating equipment repair",
    volume: 590,
    difficulty: 24,
    intent: "Commercial",
    priority: "High",
  ...
  {
    keyword: "industrial pump repair",
    volume: 880,
    difficulty: 35,
    intent: "Commercial",
    priority: "Medium",
  ...
  {
    keyword: "hydraulic drive repair",
    volume: 210,
    difficulty: 16,
    intent: "Commercial",
    priority: "Medium",
  ...
  {
    keyword: "gearbox rebuild service",
    volume: 390,
    difficulty: 27,
    intent: "Commercial",
    priority: "Medium",
  ...
  {
    keyword: "industrial equipment repair Texas",
    volume: 260,
    difficulty: 20,
    intent: "Local",
    priority: "Medium",
  ...
  {
    keyword: "centrifuge repair companies",
    volume: 140,
    difficulty: 15,
    intent: "Navigational",
    priority: "Low",
  ...
  {
    keyword: "rotating equipment maintenance",
    volume: 480,
    difficulty: 38,
...
const recommendations = [
  {
    ...
    detail:
      "KMS has a Domain Authority of 2 — the lowest possible score. Even 10–15 quality backlinks from industry directories, supplier sites, and local business associations would dramatically improve rankings. Target: DA 15+ within 6 months.",
    impact: "High",
    effort: "Medium",
  },
  {
    ...
    detail:
      "Currently only the homepage and centrifuge repair page are indexed. Gearbox, pump, blower, and hydraulic drive repair each need their own optimized pages with 800+ words, process descriptions, brand lists, and FAQ sections.",
    impact: "High",
    effort: "Medium",
  },
  {
    ...
    detail:
      "This is the highest-volume keyword in the gap analysis that KMS is not ranking for. A dedicated page with proper on-page SEO could capture 50–100 visits/month within 90 days.",
    impact: "High",
    effort: "Low",
  },
  {
    ...
    detail:
      "'Pump repair near me' gets 1,300 searches/month nationally. KMS needs a fully optimized GBP listing with photos, services, and regular posts to capture local intent searches in Southeast Texas.",
    impact: "High",
    effort: "Low",
  },
  {
    ...
    detail:
      "AI search engines (ChatGPT, Google AI Overviews, Perplexity) pull directly from FAQ schema. Adding structured Q&A to each service page positions KMS to appear in AI-generated answers for repair-related queries.",
    impact: "High",
    effort: "Low",
  },
  {
    ...
    detail:
      "Both indexed pages show 0 estimated visits despite ranking at positions 47 and 61. This suggests the pages may have technical issues (slow load, poor mobile experience) that are suppressing click-through rates.",
    impact: "Medium",
    effort: "Medium",
  },
  {
    ...
    detail:
      "Of KMS's 28 backlinks, 19 are NoFollow (no SEO value). Reach out to those linking sites to request DoFollow links, or replace low-quality links with high-authority industry directory listings.",
    impact: "Medium",
    effort: "Medium",
  },
  {
    ...
    detail:
      "Informational content (how-to guides, maintenance tips, brand-specific repair guides) builds topical authority and captures top-of-funnel traffic that converts to service inquiries over time.",
    impact: "Medium",
    effort: "High",
  },
];
...
const ImpactBadge = ({ level }: { level: string }) => {
  ...
  return (
    <span
      ...
      style={{ color: colors[level] || "#b8b8b8" }}
    >
      ↑ {level} Impact
    </span>
  );
...
export default function SeoReport() {
  const [activeTab, setActiveTab] = useState<
    "questions" | "centrifuge" | "gearbox" | "pump" | "general"
  >("questions");
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="text-right hidden md:block">
            <div className="text-xs" style={{ color: "#b8b8b8" }}>
              webwize.com · 713-416-7111
            </div>
            <div className="text-xs" style={{ color: "#b8b8b8" }}>
              Houston Web Design · Since 1994
            </div>
          </div>
        </div>
      </header>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #111111 0%, #0a0a0a 50%, rgba(249,115,22,0.05) 100%)",
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            <div>
              ...
              <p
                className="text-lg"
                style={{ color: "#b8b8b8", maxWidth: "520px" }}
              >
                A comprehensive SEO &amp; AEO analysis of{" "}
                <span style={{ color: "#F97316" }}>kmstx.com</span> —
                identifying current performance gaps, competitor advantages, and
                a prioritized roadmap to dominate rotating equipment repair
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            ...
            >
              ...
              <p className="mb-4" style={{ color: "#b8b8b8", lineHeight: 1.7 }}>
                Kelsey Machine Services is an established, 40+ year rotating
                equipment repair company with real expertise, a national service
                footprint, and a 24-month warranty that outpaces most
                competitors. However, the website currently has a{" "}
                <strong style={{ color: "#ef4444" }}>
                  Domain Authority of 2
                </strong>
                , ranks for only{" "}
                <strong style={{ color: "#ef4444" }}>2 keywords</strong>, and
                receives{" "}
                <strong style={{ color: "#ef4444" }}>
                  zero estimated organic traffic
                </strong>
                .
              </p>
              <p className="mb-4" style={{ color: "#b8b8b8", lineHeight: 1.7 }}>
                The good news: the primary competitor in the Houston market
                (houstondynamic.com) has a keyword gap of{" "}
                <strong style={{ color: "#84CC16" }}>607 keywords</strong> —
                meaning there are over 600 keywords KMS could rank for that
                competitors are already capturing. The top competitor nationally
                (centrifuge.com) has a gap of{" "}
                <strong style={{ color: "#84CC16" }}>960 keywords</strong>.
              </p>
              <p style={{ color: "#b8b8b8", lineHeight: 1.7 }}>
                With a structured content and link-building strategy, KMS can
                realistically achieve{" "}
                <strong style={{ color: "#84CC16" }}>
                  500–1,500 monthly organic visits
                </strong>{" "}
                within 12 months — representing dozens of qualified service
                inquiries per month from companies actively searching for
            ...
            <div className="flex flex-col gap-4">
              <MetricCard
                ...
                sublabel="Target: 20+ in 12 months"
                color="#ef4444"
                alert
              />
              <MetricCard
                ...
                sublabel="607 gap vs. top competitor"
                color="#ef4444"
                alert
              />
              <MetricCard
                ...
                sublabel="Massive upside potential"
                color="#ef4444"
                alert
              />
              <MetricCard
                ...
                sublabel="19 NoFollow · 9 DoFollow"
                color="#F97316"
              />
            </div>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            label="02 — Site Health"
            title="Domain"
            accent="Authority & Metrics"
          />
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <MetricCard
              value="2"
              label="Domain Authority"
              sublabel="MOZ Score (1–100)"
              color="#ef4444"
              alert
            />
            <MetricCard
              ...
              sublabel="Currently ranking"
              color="#F97316"
            />
            <MetricCard
              value="28"
              label="Total Backlinks"
              sublabel="From external domains"
              color="#F97316"
            />
            <MetricCard
              value="0"
              label="Paid Keywords"
              sublabel="No PPC campaigns active"
              color="#b8b8b8"
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  >
                    <div
                      className="h-2 rounded-full"
                      style={{ width: "68%", background: "#ef4444" }}
                    />
                  </div>
                </div>
                <div>
                  ...
                  >
                    <div
                      className="h-2 rounded-full"
                      style={{ width: "32%", background: "#84CC16" }}
                    />
                  </div>
                </div>
              </div>
              <p className="text-xs mt-6" style={{ color: "#b8b8b8" }}>
                <strong style={{ color: "#F97316" }}>Action needed:</strong> 68%
                of backlinks are NoFollow and provide no ranking benefit.
                Converting these or replacing them with DoFollow links from
                industry directories is a quick win.
              </p>
            </div>
            <div
              className="p-6 rounded-sm"
            ...
            >
              ...
              <p className="text-xs mt-4" style={{ color: "#b8b8b8" }}>
                Only 2 pages are indexed. Every service, brand, and location KMS
                serves should have its own optimized page to capture long-tail
                search traffic.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <tbody>
                {currentKeywords.map((kw, i) => (
                  ...
                  >
                        ...
                        >
                          <div
                            ...
                            style={{
                              width: `${kw.difficulty}%`,
                              background:
                                kw.difficulty < 30 ? "#84CC16" : "#F97316",
                            }}
                          />
                        </div>
                        <span
                    ...
                    <td
                      className="py-4 px-4 text-xs font-mono"
                      style={{ color: "#b8b8b8" }}
                    >
                      {kw.url}
                    </td>
          ...
          >
            <p className="text-sm" style={{ color: "#b8b8b8" }}>
              <strong style={{ color: "#F97316" }}>Key Insight:</strong> Both
              keywords rank in positions 47–61 (page 5–7 of Google) and generate
              zero clicks. Positions below 10 receive less than 1% of clicks.
              Moving "centrifuge repair" from position 61 to position 5 alone
              could generate 50–80 visits/month from this single keyword.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            label="05 — Opportunities"
            title="Keyword Gap"
            accent="Analysis"
          />
          <p className="mb-8" style={{ color: "#b8b8b8", maxWidth: "640px" }}>
            These are high-value keywords that competitors are ranking for but
            KMS is not. Each represents an opportunity to capture qualified
            traffic from prospects actively searching for rotating equipment
            repair services.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <SectionHeader
            label="06 — AEO / AI Search"
            title="Question"
            accent="Clusters"
          />
          <p className="mb-8" style={{ color: "#b8b8b8", maxWidth: "640px" }}>
            These are the questions people are actively searching around KMS's
            core services. Answering these questions directly on service pages —
            with FAQ schema markup — positions KMS to appear in Google AI
            Overviews, ChatGPT responses, and Perplexity answers.
          </p>

          {/* Tab navigation */}
          <div className="flex flex-wrap gap-2 mb-8">
            {(
              ["questions", "centrifuge", "gearbox", "pump", "general"] as const
            ).map(tab => (
              <button
                key={tab}
                ...
                style={{
                  background:
                    activeTab === tab ? "#F97316" : "rgba(255,255,255,0.06)",
                  color: activeTab === tab ? "#ffffff" : "#b8b8b8",
                  border: "1px solid",
                  borderColor:
                    activeTab === tab ? "#F97316" : "rgba(255,255,255,0.08)",
                  fontFamily: "'Space Mono', monospace",
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {(activeTab === "questions"
              ? [
                  ...aeoQuestions.centrifuge.slice(0, 4),
                  ...aeoQuestions.general.slice(0, 4),
                ]
          ...
          >
            <p className="text-sm" style={{ color: "#b8b8b8" }}>
              <strong style={{ color: "#84CC16" }}>AEO Strategy:</strong> Each
              of these questions should be answered in a dedicated FAQ section
              on the relevant service page, marked up with Schema.org FAQPage
              structured data. This is the primary mechanism by which AI search
              engines (ChatGPT, Google AI Overview, Perplexity) surface business
              answers to users — and it requires zero additional traffic to
              implement.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            {recommendations.map((rec, i) => (
              ...
              >
                ...
                <p
                  className="text-sm"
                  style={{ color: "#b8b8b8", lineHeight: 1.6 }}
                >
                  {rec.detail}
                </p>
              </div>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #111111 0%, rgba(249,115,22,0.08) 100%)",
          borderBottom: "1px solid rgba(255,255,255,0.06)",
        }}
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p
            ...
            style={{ color: "#b8b8b8" }}
          >
            WebWize has been building Houston businesses' online presence since
            1994. We're ready to execute every recommendation in this report —
            from content creation to technical SEO to link building.
          </p>
